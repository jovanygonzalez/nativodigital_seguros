...
const tblActivos_1 = __importDefault(require("../models/tblActivos"));
const VerificacionTokenController_1 = require("./VerificacionTokenController");
const database_1 = require("../database");
class TblActivosController {
    obtener(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!lRespuesta) {
                ...
                const lstRespuesta = yield tblActivos_1.default.findAll({ where: { lActivo: 1 } });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!lRespuesta) {
                    ...
                    const respuesta = yield tblActivos_1.default.create(req.body);
                    if (respuesta) {
                        return res.json({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!lRespuesta) {
                    ...
                    req.body.dtModificacion = Date.now();
                    const respuesta = yield tblActivos_1.default.update(req.body, { where: { iIdActivo: req.body.iIdActivo } });
                    if (respuesta) {
                        return res.json({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!lRespuesta) {
                    ...
                    yield tblActivos_1.default.bulkCreate(req.body, { updateOnDuplicate: ['iIdActivo', 'lActivo'] }, { transaction });
...
exports.TBLACTIVOS_CONTROLLER = new TblActivosController();
//# sourceMappingURL=TblActivosController.js.map