    ...
    obtener(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.query.lTodos == 'true') {
                lstRespuesta = yield tblServicios_1.default.findAll();
            }
            if (req.query.lTodos == 'false') {
                lstRespuesta = yield tblServicios_1.default.findAll({ where: { lActivo: 1 } });
            }
    ...
    crear(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const respuesta = yield tblServicios_1.default.create(req.body);
                if (respuesta) {
                    return res.json({
    ...
    editar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                req.body.dtModificacion = Date.now();
                const respuesta = yield tblServicios_1.default.update(req.body, { where: { iIdServicio: req.body.iIdServicio } });
                if (respuesta) {
                    return res.json({
    ...
    inactivar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield tblServicios_1.default.bulkCreate(req.body, { updateOnDuplicate: ['iIdServicio', 'lActivo'] }, { transaction });
...
exports.TBLSERVICIOS_CONTROLLER = new TblServiciosController();
//# sourceMappingURL=TblServiciosController.js.map