...
class TblRutasModulosController {
    obtener(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.query.lTodos == "true") {
                lstRespuesta = yield tblRutasModulos_1.default.findAll();
            }
    ...
    crear(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const respuesta = yield tblRutasModulos_1.default.create(req.body);
                if (respuesta) {
                    return res.json({
    ...
    editar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                req.body.dtModificacion = Date.now();
                const respuesta = yield tblRutasModulos_1.default.update(req.body, { where: { iIdRuta: req.body.iIdRuta } });
                if (respuesta) {
                    return res.json({
    ...
    inactivar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield tblRutasModulos_1.default.bulkCreate(req.body, { updateOnDuplicate: ['iIdRuta', 'lActivo'] }, { transaction });
...
exports.TBLRUTASMODULOS_CONTROLLER = new TblRutasModulosController();
//# sourceMappingURL=TblRutasModulosController.js.map