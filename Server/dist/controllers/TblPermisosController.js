    ...
    obtener(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.query.lTodos == 'true') {
                lstRespuesta = yield tblPermisos_1.default.findAll();
            }
    ...
    crear(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield tblPermisos_1.default.create(req.body, { transaction }).then((result) => {
                    lastIdPermiso = result.dataValues.iIdPermiso;
                });
    ...
    editar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield tblPermisos_1.default.update(req.body, { where: { iIdPermiso: req.body.iIdPermiso }, transaction });
                // await TblRelModulosPermisos.destroy({ where: { iIdPermiso: req.body.permiso.iIdPermiso }, transaction });
    ...
    inactivar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield tblPermisos_1.default.bulkCreate(req.body, { updateOnDuplicate: ['iIdPermiso', 'lActivo'] }, { transaction });
                yield transaction.commit();
                return res.json({
...
exports.TBLPERMISOSCONTROLLER_CONTROLLER = new TblPermisosController();
//# sourceMappingURL=TblPermisosController.js.map