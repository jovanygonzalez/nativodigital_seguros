...
class TblModulosFuncionesFuncionesController {
    obtener(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.query.lTodos == "true") {
                lstRespuesta = yield tblModulosFunciones_1.default.findAll();
            }
            if (req.query.lTodos == "false") {
                lstRespuesta = yield tblModulosFunciones_1.default.findAll({ where: { lActivo: 1 } });
            }
    ...
    crear(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const respuesta = yield tblModulosFunciones_1.default.create(req.body);
                if (respuesta) {
                    return res.json({
    ...
    editar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                //Actualiza la tabla de ModuloFunciones
                // elimina date creacion del objeto
                delete req.body.dtCreacion;
                req.body.dtModificacion = Date.now();
                yield tblModulosFunciones_1.default.update(req.body, { where: { iIdModuloFuncion: req.body.iIdModuloFuncion }, transaction });
    ...
    inactivar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield tblModulosFunciones_1.default.bulkCreate(req.body, { updateOnDuplicate: ['iIdModuloFuncion', 'lActivo'] }, { transaction });
                yield transaction.commit();
                return res.json({
...
exports.TBLMODULOSFUNCIONES_CONTROLLER = new TblModulosFuncionesFuncionesController();
//# sourceMappingURL=TblModulosFuncionesController.js.map