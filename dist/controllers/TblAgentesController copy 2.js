...
// import TblPuestos from "../models/tblAseguradoras";
class TblAseguradorasController {
    obtener(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //   lstRespuesta = await TblAseguradoras.findOne({ where: { iIdAseguradora: req.query.id } });
            // }
            res.json({ data: lstRespuesta });
        });
    }
...
//# sourceMappingURL=TblAgentesController copy 2.js.map